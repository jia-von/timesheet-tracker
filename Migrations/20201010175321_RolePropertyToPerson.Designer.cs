...
namespace Timesheet_Tracker.Migrations
{
    ...
    [Migration("20201010175321_RolePropertyToPerson")]
    partial class RolePropertyToPerson
    {
            ...
            modelBuilder.Entity("Timesheet_Tracker.Models.Person", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = -1,
                            Archive = false,
                            DateCreated = new DateTime(2020, 10, 10, 0, 0, 0, 0, DateTimeKind.Local),
            ...
            modelBuilder.Entity("Timesheet_Tracker.Models.Project", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Archive = false,
                            DateCreated = new DateTime(2020, 10, 10, 0, 0, 0, 0, DateTimeKind.Local),
                            DueDate = new DateTime(2020, 10, 10, 0, 0, 0, 0, DateTimeKind.Local),
                            EmployeeID = -2,
