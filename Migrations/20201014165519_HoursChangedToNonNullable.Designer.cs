...
namespace Timesheet_Tracker.Migrations
{
    ...
    [Migration("20201014165519_HoursChangedToNonNullable")]
    partial class HoursChangedToNonNullable
    {
            ...
            modelBuilder.Entity("Timesheet_Tracker.Models.Person", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = -1,
                            Archive = false,
                            DateCreated = new DateTime(2020, 10, 14, 0, 0, 0, 0, DateTimeKind.Local),
            ...
            modelBuilder.Entity("Timesheet_Tracker.Models.Project", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CodeReviewHours = 0f,
                            DateCreated = new DateTime(2020, 10, 14, 0, 0, 0, 0, DateTimeKind.Local),
                            DeliverablesHours = 0f,
                            DesignHours = 0f,
                            DoingHours = 0f,
                            DueDate = new DateTime(2020, 10, 14, 0, 0, 0, 0, DateTimeKind.Local),
                            EmployeeID = -2,
